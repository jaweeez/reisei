...
- [ ] Repair Google Play credentials, then verify `reisei_pro:monthly` and `reisei_pro:annual` against the store.
- [ ] Add production public SDK keys to EAS environment variables.
